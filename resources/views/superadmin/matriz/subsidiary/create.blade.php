...
@section('content')
    ...
    <main>
        ...
        <div class="container-xl px-4 mt-4">
            <form action="{{route('subsidiary.store')}}" method="POST" enctype="multipart/form-data">
                @csrf()
                <div class="row">
                    ...
                    <div class="col-xl-8">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">Detalhe do Organismos</div>
                            ...
                            <div class="card-body">
                                ...
                                <!-- Submit button-->
                                <button class="btn btn-primary" type="submit">Add Organismos</button>
                            </div>
                        </div>
                    </div>
                </div>
