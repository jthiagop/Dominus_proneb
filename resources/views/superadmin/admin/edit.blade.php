                            ...
                            <form method="POST" action="">
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" id="name" value="{{old('email', $getRecord->name)}}" name="name" type="text"
                                            placeholder="Digite o nome" required value="" />
                                    </div>
                                ...
                                <div class="row gx-3 mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="email" value="{{ old('email', $getRecord->email)}} " name="email" required type="email"
