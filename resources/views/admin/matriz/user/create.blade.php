                            ...
                            <div class="card-body">
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input class="form-control" name="name" value="{{old('name')}}" id="name" required name="name" title="Nome e Sobrenome"
                                            type="text" placeholder="Nome e sobrenome" value="" />
                                    </div>
                                    <!-- Form Group (last name)-->
                                    <div class="col-md-4">
                                        <label class="small mb-1">Tipo</label>
                                        <select class="form-select" name="user_type" required aria-label="Default select example">
