...
@section('content')
    ...
    <main>
                    ...
                    <div class="row align-items-center justify-content-between pt-3">
                        <div class="col-auto mb-3">
                            <h1 class="page-header-title">
                                ...
                                Atualizando Organismo - {{$getRecord->razaosocial}}
                            </h1>
                        </div>
                        <div class="col-12 col-xl-auto mb-3">
                            <a class="btn btn-sm btn-light text-primary" href="{{ route('org.list') }}">
        ...
        <div class="container-xl px-4 mt-4">
            <form action="{{ route('org.update', $getRecord->id) }}" method="POST" enctype="multipart/form-data">
                @csrf()
                <div class="row">
                    <div class="col-xl-4">
