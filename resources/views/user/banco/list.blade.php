                    ...
                    <div class="page-header-content">
                        <div class="row align-items-center justify-content-between pt-3">
                            ...
                            <div class="col-12 col-xl-auto mb-3">
                                ...
                                <button class="btn btn-sm btn-light text-primary filter"
                                    data-filter="Entrada">Entradas</button>
                    ...
                    <table id="datatablesSimple" class="display nowrap" >
                        ...
                        <tbody>
                            @foreach ($lancBanco as $banco)
                                <tr>
                                    <td>{{ $banco->id }}</td>
                                    <td>{{ date(' d-m-Y', strtotime($banco->data)) }}</td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            <a class="btn btn-datatable btn-icon btn-transparent-dark"
                                                href="{{ route('user.banco.edit', $banco->id) }}"><i
